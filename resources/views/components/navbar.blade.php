<nav class="bg-gray-800" x-data="{ isOpen: false }">
        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTyhcIen5Oo1vkfnD2Xlr4Fo0fz5Z2GS1ObGQ&s"
                        alt="Your Company">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <!-- Menambahkan link ke Departemen -->
                        ...
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="h-8 w-8 rounded-full"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSh4I-P3atdWGv1Sb7FSTYkgunE-5pQy5Imgg&s"
                                    alt="">
                            </button>
                        </div>
    ...
    <div class="md:hidden" x-show="isOpen" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            ...
            <!-- Menambahkan link ke Departemen di mobile menu -->
            ...
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full"
                        src="https://i2.wp.com/genshinbuilds.aipurrjects.com/genshin/characters/kachina/image.png?strip=all&quality=75&w=256 "
                        alt="">
                </div>
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Kachina</div>
                    <div class="text-sm font-medium leading-none text-gray-400">kachina@gmail.com</div>
                </div>
            </div>
